...
subprocess.call("xterm -e sudo python3 local_training_gateway.py --name h3  --solution 1 &",shell=True)
subprocess.call("xterm -e sudo python3 local_training_gateway.py --name h4  --solution 1 &",shell=True)
subprocess.call("xterm -e sudo python3 local_training_gateway.py --name h5  --solution 1 &",shell=True)
